...
namespace System
{
    ...
    /// <summary>
    ///     Represents a typed weak reference, which references an object while still allowing that object to be reclaimed
    ...
    public sealed class WeakReference<T> : ISerializable where T : class
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:System.WeakReference`1" /> class that references the specified
        ///     object.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:System.WeakReference`1" /> class that references the specified
        ///     object and uses the specified resurrection tracking.
        /// </summary>
        /// <param name="target">The object to reference, or <see langword="null" />.</param>
        /// <param name="trackResurrection">
        ///     <see langword="true" /> to track the object after finalization; <see langword="false" /> to track the object only
        ///     until finalization.
        /// </param>
        ...
        /// <summary>
        ///     Populates a <see cref="T:System.Runtime.Serialization.SerializationInfo" /> object with all the data necessary
        ///     to serialize the current <see cref="T:System.WeakReference`1" /> object.
        /// </summary>
        /// <param name="info">
        ///     An object that holds all the data necessary to serialize or deserialize the current
        ///     <see cref="T:System.WeakReference`1" /> object.
        /// </param>
        ...
        /// <summary>
        ///     Tries to retrieve the target object that is referenced by the current <see cref="T:System.WeakReference`1" />
        ///     object.
        /// </summary>
        /// <param name="target">
        ...
        /// </param>
        /// <returns>
        ///     <see langword="true" /> if the target was retrieved; otherwise, <see langword="false" />.
        /// </returns>
        ...
        /// <summary>
        ///     Discards the reference to the target that is represented by the current
        ///     <see cref="T:System.WeakReference`1" /> object.
        /// </summary>
