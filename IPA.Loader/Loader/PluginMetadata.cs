...
namespace IPA.Loader
{
    ...
    public class PluginMetadata
    {
        ...
        /// </summary>
        /// <value>the <see cref="System.Uri" /> of the plugin's home page</value>
        ...
        {
            return
                $"{Name}({Id}@{HVersion})({PluginType?.FullName}) from '{Utils.GetRelativePath(File?.FullName ?? "", UnityGame.InstallPath)}'";
        }
    }
}