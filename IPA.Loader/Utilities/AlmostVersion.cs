...
{
    /// <summary>
    ///     A type that wraps <see cref="Hive.Versioning.Version" /> so that the string of the version is stored when the
    ///     string is
    ///     not a valid <see cref="Hive.Versioning.Version" />.
    /// </summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
    {
        ...
        public AlmostVersion(SVersion ver) : this(
            ver?.UnderlyingVersion ?? throw new ArgumentNullException(nameof(ver)))
        {
        }
        ...
        /// <summary>
        ///     Compares <see langword="this" /> to the <see cref="AlmostVersion" /> in <paramref name="other" /> using
        ///     <see cref="Version.CompareTo(Version)" />
        ...
        /// <returns>
        ///     less than 0 if <paramref name="other" /> is considered bigger than <see langword="this" />, 0 if equal, and
        ///     greater than zero if smaller
        /// </returns>
        ...
        /// <summary>
        ///     Compares <see langword="this" /> to the <see cref="Version" /> in <paramref name="other" /> using
        ///     <see cref="Version.CompareTo(Version)" />.
        /// </summary>
        /// <remarks>
        ///     The storage method of <see langword="this" /> must be <see cref="StoredAs.SemVer" />, else an
        ///     <see cref="InvalidOperationException" /> will
        ///     be thrown.
        /// </remarks>
        ...
        public int CompareTo(Version other)
        {
            if (StorageMode != StoredAs.SemVer)
            {
                throw new InvalidOperationException(
                    "Cannot compare a SemVer version with an AlmostVersion stored as a string!");
            }
        ...
        /// <summary>
        ///     Compares <see langword="this" /> to the <see cref="SVersion" /> in <paramref name="other" /> using
        ///     <see cref="Version.CompareTo(Version)" />.
        /// </summary>
        /// <remarks>
        ///     The storage method of <see langword="this" /> must be <see cref="StoredAs.SemVer" />, else an
        ...
        {
            return CompareTo(other.UnderlyingVersion);
        }
        ...
        private bool TryParseFrom(string str, StoredAs mode)
        {
            ...
            {
                StorageMode = StoredAs.SemVer;
                bool result = Version.TryParse(str, out Version? version);
                SemverValue = version;
                return result;
            }
        ...
        {
            return StorageMode == StoredAs.SemVer ? SemverValue!.ToString() : StringValue!;
        }
        ...
        /// </summary>
        /// <remarks>
        ///     This may return <see langword="false" /> where <see cref="operator ==(AlmostVersion, AlmostVersion)" /> returns
        ///     <see langword="true" />
        /// </remarks>
        ...
        /// </summary>
        /// <returns>
        ///     a value unique to each object, except those that are considered equal by <see cref="Equals(object)" />
        /// </returns>
        /// <seealso cref="object.GetHashCode" />
        public override int GetHashCode()
        {
            int hashCode = -126402897;
        ...
        /// </summary>
        /// <remarks>
        ///     This is a looser equality than <see cref="Equals(object)" />, meaning that this may return <see langword="true" />
        ///     where <see cref="Equals(object)" />
        ///     does not.
        /// </remarks>
...
#pragma warning disable CA2225 // Operator overloads have named alternates
        /// <summary>
        ///     Implicitly converts a <see cref="SVersion" /> to <see cref="AlmostVersion" /> using
        ///     <see cref="AlmostVersion(SVersion)" />.
        /// </summary>
        ...
        public static implicit operator AlmostVersion?(SVersion? ver)
        {
            return ver is null ? null : new AlmostVersion(ver);
        }

        // implicitly convertible to Version
        /// <summary>
        ///     Implicitly converts an <see cref="AlmostVersion" /> to <see cref="SVersion" />, if applicable, using
        ///     <see cref="SemverValue" />.
        ...
        [Obsolete("Use Hive.Versioning.Version instead of SemVer.Version")]
        public static implicit operator SVersion?(AlmostVersion? av)
        {
            return av?.SemverValue is not null ? SVersion.ForHiveVersion(av.SemverValue) : null;
        }
#pragma warning restore CS0618 // Type or member is obsolete
        /// <summary>
        ///     Implicitly converts a <see cref="SVersion" /> to <see cref="AlmostVersion" /> using
...
#pragma warning restore CA2225 // Operator overloads have named alternates
    ...
    public sealed class AlmostVersionConverter : ValueConverter<AlmostVersion>
    {
        ...
        {
            return Converter<string>.Default.FromValue(value, parent) switch
            {
                { } v => new AlmostVersion(v),
                _ => null
            };
        }
