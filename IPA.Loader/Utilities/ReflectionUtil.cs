...
namespace IPA.Utilities
{
    ...
    public static class ReflectionUtil
    {
        internal static readonly FieldInfo DynamicMethodReturnType =
            typeof(DynamicMethod).GetField("returnType",
        ...
        ///     if <paramref name="fieldName" /> does not exist on <typeparamref name="T" />
        /// </exception>
        ...
        ///     if <paramref name="propertyName" /> does not exist on
        ///     <typeparamref name="T" />
        /// </exception>
        ...
        ///     if <paramref name="methodName" /> does not exist on <typeparamref name="T" />
        /// </exception>
        public static U InvokeMethod<U, T>(this T obj, string methodName, params object[] args)
        {
            MethodInfo dynMethod = typeof(T).GetMethod(methodName,
        ...
        /// <summary>
        ///     Copies a component <paramref name="original" /> to a component of <paramref name="overridingType" /> on the
        ///     destination <see cref="GameObject" />.
        /// </summary>
        ...
        public static Component CopyComponent(this Component original, Type overridingType, GameObject destination,
            Type originalTypeOverride = null)
        {
            Component copy = destination.AddComponent(overridingType);
            Type originalType = originalTypeOverride ?? original.GetType();
        ...
        /// <param name="originalTypeOverride">overrides the source component type (for example, to a superclass)</param>
        /// <returns>the copied component</returns>
        public static T CopyComponent<T>(this Component original, GameObject destination,
            Type originalTypeOverride = null)
            where T : Component
        {
