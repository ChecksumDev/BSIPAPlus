...
namespace IPA.Utilities.Async
{
    ...
    public static class Synchronization
    {
        ...
        public struct ReaderWriterLockSlimUpgradableReadLocker : IDisposable
        {
            ...
            /// <seealso cref="Synchronization" />
            public ReaderWriterLockSlimWriteLocker Upgrade()
            {
                return new ReaderWriterLockSlimWriteLocker(rwl);
            }
        ...
        public static MutexLocker Lock(Mutex mut)
        {
            return new MutexLocker(mut);
        }
        ...
        /// <returns>the locker to use with <see langword="using" /></returns>
        public static SemaphoreLocker Lock(Semaphore sem)
        {
            return new SemaphoreLocker(sem);
        }
        ...
        /// <returns>the locker to use with <see langword="using" /></returns>
        public static SemaphoreSlimLocker Lock(SemaphoreSlim sem)
        {
            return new SemaphoreSlimLocker(sem);
        }
        ...
        {
            SemaphoreSlimAsyncLocker locker = new(sem);
            await locker.Lock();
            return locker;
        }
#endif
        ...
        /// <returns>the locker to use with <see langword="using" /></returns>
        public static ReaderWriterLockSlimWriteLocker LockWrite(ReaderWriterLockSlim rwl)
        {
            return new ReaderWriterLockSlimWriteLocker(rwl);
        }
        ...
        /// <returns>the locker to use with <see langword="using" /></returns>
        public static ReaderWriterLockSlimReadLocker LockRead(ReaderWriterLockSlim rwl)
        {
            return new ReaderWriterLockSlimReadLocker(rwl);
        }
        ...
        /// <returns>the locker to use with <see langword="using" /></returns>
        public static ReaderWriterLockSlimUpgradableReadLocker LockReadUpgradable(ReaderWriterLockSlim rwl)
        {
            return new ReaderWriterLockSlimUpgradableReadLocker(rwl);
        }
