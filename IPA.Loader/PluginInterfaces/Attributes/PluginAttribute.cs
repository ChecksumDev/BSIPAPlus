...
namespace IPA
{
    ...
    public enum RuntimeOptions
    {
        ...
        ///         <see cref="SingleStartInit" />,
        ///         it will be initialized and enabled with the game if it is enabled on startup, and disabled with the game if it
        ///         is enabled
        ///         on shutdown.
        ///     </para>
        ///     <para>
        ///         When a plugin with this set is enabled mid-game, the first time it is enabled, its initialization methods will
        ///         be called,
        ///         then its enable methods. All subsequent enables will <b>NOT</b> re-initialize, however the enable methods will
        ///         be called.
        ///     </para>
        ///     <para>
        ///         When a plugin with this set is disabled mid-game, the plugin instance will <b>NOT</b> be destroyed, and will
        ///         instead be
        ///         re-used for subsequent enables. The plugin is expected to handle this gracefully, and behave in a way that
        ///         makes sense.
        ///     </para>
        /// </summary>
    ...
    /// <remarks>
    ///     <para>
    ///         If more than one constructor is marked with this attribute, the one with the most parameters, whether or not
    ///         they can be injected, will be used.
    ///     </para>
    ///     <para>
