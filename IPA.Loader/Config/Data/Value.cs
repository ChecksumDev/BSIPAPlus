...
namespace IPA.Config.Data
{
    ...
    public abstract class Value
    {
        ...
        /// <seealso cref="From(System.Collections.Generic.IEnumerable{IPA.Config.Data.Value})" />
        ...
        {
            return val == null ? null : new Text(val);
        }
        ...
        {
            return From(vals as IEnumerable<KeyValuePair<string, Value?>>);
        }
        ...
        public static Map? From(IEnumerable<KeyValuePair<string, Value?>>? vals)
        {
            ...
            Map m = Map();
            foreach (KeyValuePair<string, Value?> v in vals) m.Add(v.Key, v.Value);
            return m;
        }
    }
}