...
namespace IPA.Config
{
    ...
    public class ModPrefs : IModPrefs
    {
        ...
        {
            return StaticInstance.GetString(section, name, defaultValue, autoSave);
        }
        ...
        {
            return StaticInstance.GetInt(section, name, defaultValue, autoSave);
        }
        ...
        {
            return StaticInstance.GetFloat(section, name, defaultValue, autoSave);
        }
        ...
        {
            return StaticInstance.GetBool(section, name, defaultValue, autoSave);
        }
        ...
        {
            return StaticInstance.HasKey(section, name);
        }
